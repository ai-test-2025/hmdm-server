...
(Get-Content "$tomcat_base\conf\$TOMCAT_ENGINE_NAME\$TOMCAT_HOST_NAME\$hmdm_root.xml").replace("$SMTP_FROM","admin@hmdm.com") | Set-Content "$tomcat_base\conf\$TOMCAT_ENGINE_NAME\$TOMCAT_HOST_NAME\$hmdm_root.xml"
